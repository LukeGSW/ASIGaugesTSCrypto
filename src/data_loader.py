# src/data_loader.py (VERSIONE CON DEBUG DEL TRACEBACK)

import streamlit as st
import pandas as pd
import traceback  # <-- Importiamo il modulo per il traceback

# Importiamo il nostro modulo di servizio
...
def load_production_asi() -> pd.DataFrame:
    ...
    try:
        ...
        # --- BLOCCO DI DEBUG PER TRACEBACK COMPLETO ---
        ...
        # Stampa l'intero traceback nell'app per vedere esattamente dove si verifica l'errore
